...
http_archive(
	name = "com_github_bazelboost_iostreams",
	strip_prefix = "iostreams-boost-1.65.1",
	urls = [
		"https://github.com/bazelboost/iostreams/archive/boost-1.65.1.tar.gz"
	],
)
...
http_archive(
	name = "com_github_bazelboost_proto",
	strip_prefix = "proto-boost-1.65.1",
	urls = [
		"https://github.com/bazelboost/proto/archive/boost-1.65.1.tar.gz"
	],
)
...
http_archive(
	name = "com_github_bazelboost_endian",
	strip_prefix = "endian-boost-1.65.1",
	urls = [
		"https://github.com/bazelboost/endian/archive/boost-1.65.1.tar.gz"
	],
)

http_archive(
	name = "com_github_bazelboost_tti",
	strip_prefix = "tti-boost-1.65.1",
	urls = [
		"https://github.com/bazelboost/tti/archive/boost-1.65.1.tar.gz"
	],
)
...
http_archive(
	name = "com_github_bazelboost_locale",
	strip_prefix = "locale-boost-1.65.1",
	urls = [
		"https://github.com/bazelboost/locale/archive/boost-1.65.1.tar.gz"
	],
)

http_archive(
	name = "com_github_bazelboost_phoenix",
	strip_prefix = "phoenix-boost-1.65.1",
	urls = [
		"https://github.com/bazelboost/phoenix/archive/boost-1.65.1.tar.gz"
	],
)
